...
INSERT INTO "new_Tournament" ("created_at", "created_by", "id", "king_max_rounds", "king_max_time", "max_participants", "mode", "name", "status") SELECT "created_at", "created_by", "id", "king_max_rounds", "king_max_time", "max_participants", "mode", "name", "status" FROM "Tournament";
